...
use Admin\Repository\SakuraRepository;
...
class GetController extends EditDisplayController
{
     ...
     *
     * @var  SakuraRepository
     */
    protected $repository = 'Sakura';
    ...
    {
        /**
         * @var $view       SakuraHtmlView
         * @var $repository SakuraRepository
         */
