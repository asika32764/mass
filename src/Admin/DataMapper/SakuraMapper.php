...
/**
 * The SakuraMapper class.
 *
 * @since  1.0
 */
class SakuraMapper extends AbstractDatabaseMapperProxy
{
    /**
     * Property table.
     *
     * @var  string
     */
    protected static $table = Table::SAKURAS;
     ...
     * @var  string
     */
    protected static $dataClass = SakuraRecord::class;
